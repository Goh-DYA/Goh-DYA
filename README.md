...
| ARWEN (Architect of Reflective Wisdom and Empathetic Narratives) - LLM Digital Human<br>*(Top-5 Finalist, SGHackitRx 2025)* | [YouTube Demo](https://youtu.be/fAKeaVOONFg) | *Models*: Amazon Titan Image Generator (Image generation), Claude Sonnet 4, Amazon Nova Pro (Text generation), Convai (Digital Human platform) |
